...
margin:100px;
    ...
    .category{
        background-color:rgba(42, 100, 173, 0.30);
        width: 50px;
        height: 28px;
        padding:10px;
        border-radius: 25px;
